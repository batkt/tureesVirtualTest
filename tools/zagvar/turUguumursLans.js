...
`
  ...
  medeelel.zardluud
    ...
    .filter((a) => a.tailbar?.includes("түрээс"))
    .forEach((mur) => {
      murNemekh.push(`
        <tr>
  ...
  medeelel.zardluud
    .filter(
      (a) => !a.tailbar?.includes("түрээс") && a.tailbar != "Хөнгөлөлт",
    )
    .forEach((mur) => {
      murNemekh.push(`
        <tr>
  ...
  <div style="width: 100%; padding: 1rem; page-break-after: always;">
    ...
    <div style="display: flex; justify-content: space-between; margin-top: 10px;">
      <div style="padding: 1rem; flex: 1;">
        <p style="font-weight: 600; font-size:14px;">Нэхэмжлэгч: Өгөөмөр Ланс ХХК</p>
        <div style="display: flex; font-size:12px; justify-content: space-between;">
          <span>Байгууллагын нэр:</span>
          <span style="font-size:12px;">Өгөөмөр Ланс ХХК
          </span> 
        </div>

        <div style="display: flex;font-size:12px; justify-content: space-between;">
          <span>РД: </span>
          <span style="">2647583</span>
        </div>
        <div style="display: flex; font-size:12px; justify-content: space-between;">
          <span>Хаяг:</span>
          <span style="">&nbsp;&lt;khayag&gt;</span>
        </div>
        <div style="display: flex; font-size:12px; justify-content: space-between;">
          <span>Утас:</span>
          <span style="">91917831</span>
        </div>
        <div style="display: flex; font-size:12px; justify-content: space-between;">
          <span>Э-шуудан:</span>
          <span style="">mandalbayarbat@gmail.com</span>
        </div>
        <div style="display: flex; font-size:12px; justify-content: space-between;">
          <span>Банкны нэр:</span>
          <span style="">Худалдаа хөгжлийн банк</span>
        </div>
        <div style="display: flex; font-size:12px; justify-content: space-between;">
...
export default khatuuZagvarLans;
