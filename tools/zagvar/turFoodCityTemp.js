      ...
      <table style="width: 100%;">
        ...
        ${medeelel.zardluud.filter(a => a.tailbar === "Түрээс хуучин үнэ 8/01-8/15 хооронд" || a.tailbar === "Түрээс шинэ үнэ 8/16-8/31 хооронд" || a.tailbar === "Түрээсийн төлбөр нэмэлт").length > 0 ? "" :
          ...
          ${medeelel.zardluud
            ...
            .filter(a => a.tailbar === "Менежментийн төлбөр" || a.tailbar === "Менежментийн зардал" || a.tailbar === "Менежмент" || a.tailbar === "Менежментийн төлбөр нэмэлт" || a.tailbar == "Түрээсийн төлбөр нэмэлт")
            .map((mur, index) => {
              return `
                <tr key=${index}>
                  <td style="border: 1px solid #000; text-align: center;">${
