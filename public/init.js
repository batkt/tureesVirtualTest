...
function init_impl(callback) {
    ...
    if(/Android|webOS|iPhone|iPod|BlackBerry/i.test(navigator.userAgent)) {
        // if(1) {
        var common_lib_js = ["../../js/common_lib.js?version=" + version.web];
        var common_js = ["../../js/common.js?version=" + version.web];
        var mui_js = ["../mobile/js/mui.min.js"];
        var mCommon_js = ["../mobile/js/mCommon.js?version=" + version.web];
        var flexible_js = ["../mobile/js/flexible.debug.js"];
        var flexible_css_js = ["../mobile/js/flexible_css.debug.js"];
        var jqueryFileTree_js = ["../../js/FileTree/jqueryFileTree.js"];
        var picker_js = ["../mobile/js/mui.picker.min.js"];
        var poppicker_js = ["../mobile/js/mui.poppicker.js"];
        var business_js = ["../mobile/js/business.js?version=" + version.web];

        var mui_css = ["../mobile/css/mui.min.css"];
        var common_css = ["../mobile/css/common.css?version=" + version.web];
        var picker_css = ["../mobile/css/mui.picker.min.css"];
        var poppicker_css = ["../mobile/css/mui.poppicker.css"];
        var jqueryFileTree_css = ["../../js/FileTree/jqueryFileTree.css"];
        var flv_js = ["../mobile/js/index.js?version=" + version.web];

        var jchs = Array();
        if(cur_page == "login.htm"){
            add_css(jchs, mui_css);
            add_css(jchs, picker_css);
            add_css(jchs, poppicker_css);
            add_css(jchs, common_css);

            add_js(jchs,common_lib_js);
            add_js(jchs,common_js);
            add_js(jchs,mui_js);
            add_js(jchs,picker_js);
            add_js(jchs,poppicker_js);
            add_js(jchs,mCommon_js);
            add_js(jchs,flexible_js);
            add_js(jchs,flexible_css_js);
        }else if(cur_page == "main.htm"){
            add_css(jchs, mui_css);
            add_css(jchs, picker_css);
            add_css(jchs, poppicker_css);
            add_css(jchs, jqueryFileTree_css);
            add_css(jchs, common_css);

            add_js(jchs,common_lib_js);
            add_js(jchs,common_js);
            add_js(jchs,jqueryFileTree_js);
            add_js(jchs,mui_js);
            add_js(jchs,picker_js);
            add_js(jchs,poppicker_js);
            add_js(jchs,mCommon_js);
            add_js(jchs,business_js);
            add_js(jchs,flexible_js);
            add_js(jchs,flexible_css_js);
            add_js(jchs,flv_js);
        }
        ...
        var common_lib_js = ["js/common_lib.js?version=" + version.web];
        var common_js = ["js/common.js?version=" + version.web];
        var business_js = ["js/business.js?version=" + version.web];
        var page_base_js = ["js/style.js?version=" + version.web];

        var jss = Array();
        add_js(jss, common_lib_js);
        add_js(jss, common_js);
        add_js(jss, business_js);
