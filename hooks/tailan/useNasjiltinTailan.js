...
function useNasjiltinTailan(token, query, searchKeys, khuudasniiKhemjee) {
  ...
  const { data, mutate, isValidating } = useSWR(
    !!token
      ? ["/nasjiltinTailan", token, query, searchKeys, khuudaslalt]
      : null,
    fetcher,
    { revalidateOnFocus: false }
  );
  return {
    nasjiltinTailan: data,
    tailanMutate: mutate,
...
export default useNasjiltinTailan;
