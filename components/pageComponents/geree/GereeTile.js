import { EditOutlined, EyeOutlined, FieldTimeOutlined, MinusCircleOutlined, RedoOutlined } from "@ant-design/icons"
...
function GereeTile({
  ...
  return (
    <Popover
      ...
      content={() => (
        <div className="flex w-24 flex-col">
          <a
            className="ant-dropdown-link flex w-full h-full items-center justify-between rounded-lg p-2 hover:bg-green-100 dark:hover:bg-gray-700"
            onClick={(e) => {
              e.preventDefault();
              e.stopPropagation();
            ...
            <a
              ...
              onClick={(e) => {
                ...
                if (
                  ...
                  router.push(
                    `/khyanalt/geree/gereeBaiguulakh/${ugugdul._id}`
                  );
                else
          ...
          {tileProps.shuult?.utga !== "Цуцласан" && (
            ...
            <a className="ant-dropdown-link flex items-center justify-between rounded-lg p-2 hover:bg-green-100 dark:text-white dark:hover:bg-gray-700" onClick={(e) => {
              e.preventDefault();
              e.stopPropagation();
              Modal.confirm({
    ...
    >
      <div
        className={`mb-3 rounded-md border border-solid border-gray-400 bg-white p-2 bg-opacity-30 dark:bg-opacity-30 shadow-2xl dark:bg-gray-900 ${turGereeEsekh === true ? "bg-purple-600 dark:bg-purple-400" : "bg-blue-500 dark:bg-blue-400"}`}
      >
