                            ...
                            {khungulultuudId?.map((z) => {
                              return JSON.parse(a.umnukhUtga)?.filter(
                                ...
                                <tr className="flex border-t">
                                  ...
                                  <td className="w-1/4 overflow-hidden border-r p-1 text-center"></td>
                                  <td className="w-1/6 overflow-hidden border-r p-1 text-center"></td>
                                  <td className="w-1/6 overflow-hidden border-r p-1 text-center"></td>
                                  <td className="w-1/6 overflow-hidden p-1 text-right"></td>
                                </tr>
                              );
                            })}
                          </tbody>
                      ...
                      a.talbar !== "baritsaaBairshuulakhKhugatsaa" ? (
                        ...
                        >
                          ...
                          >
                            ...
                            {zardluudId?.map((z) => {
                              return JSON.parse(a.shineUtga)?.filter(
                                (b) => b._id === z
                              )?.length > 0 ? (
