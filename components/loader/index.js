...
export default function Loader() {
  return (
    <div className="fixed z-50 top-0 left-0 flex h-screen w-screen select-none items-center justify-center rounded-xl bg-white bg-opacity-60 transition-all dark:bg-black dark:bg-opacity-60">
