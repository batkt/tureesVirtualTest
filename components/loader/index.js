...
export default function Loader() {
  ...
  return (
    <div className="absolute z-10 flex h-full w-full select-none items-center rounded-xl justify-center bg-white bg-opacity-60 transition-all dark:bg-black dark:bg-opacity-60">
      ...
      <div className="z-20 flex h-44 w-44 items-center justify-center overflow-hidden rounded-full bg-white p-2 shadow-xl dark:bg-gray-800 lg:h-[15vw] lg:w-[15vw]">
