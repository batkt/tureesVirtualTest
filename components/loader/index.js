...
export default function Loader() {
  ...
  return (
    <div className="absolute z-10 flex h-full w-full select-none items-center justify-center bg-white bg-opacity-60 transition-all dark:bg-black dark:bg-opacity-60">
