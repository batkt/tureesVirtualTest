        ...
        <div className='block xl:grid grid-cols-2 gap-4'>
          <div className="hidden xl:flex flex-col min-h-screen z-10">
            <a href="" className="-intro-x flex items-center pt-5">
              <img alt="Icewall Tailwind HTML Admin Template" className="w-6" src="/car.png" />
              <span className="text-white text-lg ml-3">
                Hi <span className="font-medium">Car</span>
              </span>
            </a>
            <div className="my-auto">
              <img alt="Icewall Tailwind HTML Admin Template" className="-intro-x w-1/2 -mt-16" src="http://icewall-laravel.left4code.com/dist/images/illustration.svg" />
              <div className="-intro-x text-white font-medium text-4xl leading-tight mt-10">Авто машины бүртгэл <br /> Засварын систем</div>
            </div>
          </div>
          <div className='h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0'>
            <div className='my-auto mx-auto xl:ml-20 bg-white dark:bg-gray-900 xl:dark:bg-gray-800 xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto'>
              ...
              <Form form={form} initialValues={{}} onKeyDown={(e) => {
                if (e.key === 'Enter')
              ...
              <div className="intro-x flex text-gray-700 dark:text-gray-600 text-xs sm:text-sm mt-4">
                <div className="flex items-center mr-auto">
                  <input id="remember-me" type="checkbox" className="form-check-input border mr-2" onChange={({ target }) => setNamaigsana(target.checked)} />
                  <label className="cursor-pointer select-none" htmlFor="remember-me">Намайг сана</label>
                </div>
                <a href="">Нууц үг сэргээх?</a>
              </div>

              <button
                onClick={() => newterya({ ...form.getFieldsValue(), namaigsana })}
                className="mt-5 xl:mt-8 group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-blue-800 hover:bg-blue-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
              >
              ...
              <div className="fixed bottom-0">
                © Zev-TABS LLC © {moment(new Date()).format("YYYY")}. Бүх эрх хуулиар
                баталгаажсан.
