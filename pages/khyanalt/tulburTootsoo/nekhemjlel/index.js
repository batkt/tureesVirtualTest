...
function tulburTootsoo({ token }) {
  ...
  useEffect(() => {
    const fetchDugaar = async () => {
      if (ajiltan?.baiguullagiinId === "696dcd6c527f69e3ea0f7473" ||
    ...
    if (barimt && songogdsonGereenuud && Array.isArray(songogdsonGereenuud))
      return songogdsonGereenuud
        ...
        ?.map((a, i) => {
          ...
          if (medeelel?.zardluud) {
            medeelel.zardluud = medeelel.zardluud.map((z) => {
              if (z.tariff) {
                const tariff =
                  parseFloat(
                    typeof z.tariff === "string"
                      ? z.tariff.replace(/,/g, "")
                      : z.tariff || 0
                  ) || 0;
                
                  medeelel[`${z.tailbar}.tariff`] = formatNumber(tariff);
                  medeelel[`${z.tailbar}.negj`] = formatNumber(z.negj);
                  medeelel[`${z.tailbar}.umnukhZaalt`] = z.umnukhZaalt;
                  medeelel[`${z.tailbar}.suuliinZaalt`] = z.suuliinZaalt;
                  medeelel[`${z.tailbar}.khungulult`] = formatNumber(z.khungulult);
                  medeelel[`${z.tailbar}.khungulultKhassanTulukhDun`] = formatNumber(z.khungulultKhassanTulukhDun);
                ...
                return { ...z, tariff: formatNumber(tariff) };
              }
               medeelel[`${z.tailbar}.tariff`] = formatNumber(z.tariff);
              medeelel[`${z.tailbar}.negj`] = formatNumber(z.negj);
              medeelel[`${z.tailbar}.umnukhZaalt`] = z.umnukhZaalt;
              medeelel[`${z.tailbar}.suuliinZaalt`] = z.suuliinZaalt;
              medeelel[`${z.tailbar}.khungulult`] = formatNumber(z.khungulult);
  ...
  function mailIlgeeye() {
    ...
    if (!excelZagvarSongogdson) {
      ...
      songogdsonGereenuud.map((mur, index) => {
        ...
        //gumuda
        if (ajiltan?.baiguullagiinId === "612f457d185280db676d0b51" && barilgiinId === "633e52ba9e57e626978b7c47" || ajiltan?.baiguullagiinId === "6937c18083d36cf495dfa855" && barilgiinId === "6937c18083d36cf495dfa856")
        { 
          if (barilga?.logo) {
            nekhemjlekh.barilgiinlogo = renderToString(
              <span>
