...
function Khyanalt({token}) {
  ...
  return <Admin title="Мэдэгдэл" khuudasniiNer='medegdel' className='p-0 md:p-4'>
      <div className='col-span-12 lg:col-span-4 xl:col-span-3'>
        ...
        <div>
            <Tab token={token} baiguullaga={baiguullaga} setKhariltsagch={setKhariltsagch} khariltsagch={khariltsagch} ilgeekhTurul={ilgeekhTurul} setIlgeekhTurul={setIlgeekhTurul} davkhar={davkhar}/>
        </div>
      </div>
      <div className='intro-y col-span-12 lg:col-span-8 xl:col-span-9' style={{height:'calc(100vh - 7rem)'}}>
        <Content token={token} khariltsagch={khariltsagch} ilgeekhTurul={ilgeekhTurul} baiguullaga={baiguullaga} davkhar={davkhar} setDavkhar={setDavkhar}/>
      </div>
  </Admin>;
}
