...
function AjiltanBurtgel({ token }) {
  ...
  return (
    <Admin title="Тайлан" khuudasniiNer="tailan" className="p-0 md:p-4">
      <div className="col-span-12 box p-2 space-x-2">
        <DatePicker.RangePicker locale={local}/>
        <Select placeholder='Борлуулалт'>
          <Select.Option key='Хамгийн их' value='Хамгийн их'>Хамгийн их</Select.Option>
          <Select.Option key='Хамгийн бага' value='Хамгийн бага'>Хамгийн бага</Select.Option>
        </Select>
      ...
      <div className="md:col-span-6 col-span-12 box p-2 divide-y">
        <BarChart data={data}/>
      </div>
      <div className="md:col-span-6 col-span-12 box p-2 divide-y">
        <VerticarlBarChart data={data}/>
      </div>
      <div className="md:col-span-6 col-span-12 box p-2"><PieChart/></div>
      <div className="md:col-span-6 col-span-12 box p-2"><LineChart data={data}/></div>
    </Admin>
  );
}
